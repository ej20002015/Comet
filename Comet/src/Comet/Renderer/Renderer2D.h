...
namespace Comet
{
	...
	public:
		...
		static void drawTexturedQuad(const glm::vec2& centerCoordinates, Reference<Texture2D> texture, const glm::vec2& scale = glm::vec3(1.0f), const glm::vec4& colorTint = glm::vec4(1.0f), float tilingFactor = 1.0f);
		static void drawTexturedQuad(const glm::vec3& centerCoordinates, Reference<Texture2D> texture, const glm::vec2& scale = glm::vec3(1.0f), const glm::vec4& colorTint = glm::vec4(1.0f), float tilingFactor = 1.0f);
